...
class SceneViewer( QtWidgets.QWidget ):
    ...
    def CreateVTKRenderer(self):        
        ...
        self.ren.GetActiveCamera().SetPosition(0, -30000, 10000)
...
#        self.ren.SetBackground(0.0,0.0,0.0)
        ...
        self.cornerAnnotation.SetText(0, "Instituto Superior de Engenharia do Porto" ) # m_TextAnnotation2.c_str() )
        self.cornerAnnotation.SetText(1, "Carlos Silva & Carlos A. Vinhais" ) # m_TextAnnotation3.c_str() )
        self.cornerAnnotation.SetText(2, "Total Points: 0")
        self.cornerAnnotation.SetText(3, "PPS: 0" ) # m_TextAnnotation3.c_str() )
    ...
    def CreateXYPlane(self):
        ...
        #planeSource.SetNumberOfSides(50)
        #planeSource.SetRadius(12000)
        #planeSource.SetCenter(0, 0, 0)
        planeSource.SetXResolution( 24 )
        planeSource.SetYResolution( 24 )
        planeSource.SetOrigin( -12000, -12000, 0 )
        planeSource.SetPoint1(  12000, -12000, 0 )
        planeSource.SetPoint2( -12000,  12000, 0 )
        planeSource.Update()    
